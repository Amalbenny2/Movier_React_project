...
function Popular() {
  ...
  useEffect(() => {
    axios
      .get("https://api.themoviedb.org/3/discover/movie?api_key=9948beaa1978b07ef733bcbe5e8d2849&with_genres=10749")
      .then((response) => {
        console.log(response.data);
        setData(response.data.results); // Access the 'results' array
      })
      .catch((error) => {
  ...
  return (
    <div>
    <div style={{ backgroundColor: 'lightcoral', minHeight: '100vh', color: 'white' }}>
    <Container>
      <br></br>
